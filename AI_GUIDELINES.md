# AI Development Guidelines: Arabia Khaleej Project

This document provides core principles and technical standards for AI assistants (like Gemini/Antigravity) working on the Arabia Khaleej project.

---

## I. CORE PHILOSOPHY & AUTONOMY
1. **Senior Developer Mindset:** Act as a lead developer. Take full ownership of the project. Research and implement the best possible solutions autonomously.
2. **Anti-Hallucination:** Strictly avoid hallucinations. Every technical implementation and content piece must be verified and logical.
