    ...
    <>
      ...
      <header className="mb-16">
        ...
        <p className="text-base sm:text-lg font-light leading-relaxed opacity-70 max-w-xl">
          We built Arabia Khaleej to be read, not to harvest. Your privacy is
          not a feature — it is a default.
        </p>
      </header>

      {/* Privacy-first badge */}
      <div className="glass rounded-2xl px-8 py-6 mb-10 border border-brand-gold/15 flex items-center gap-5">
        ...
        <div>
          ...
          <p className="text-sm font-light opacity-70 leading-relaxed">
            No accounts. No cookies. No trackers. Full anonymity by design.
          </p>
        </div>
      </div>
        ...
        {sections.map(({ title, body }, i) => (
          ...
          >
            <summary className="flex items-center gap-4 px-6 py-5 cursor-pointer list-none select-none">
              ...
              <span className="text-sm font-bold uppercase tracking-widest flex-grow">
                {title}
              </span>
            ...
            <p className="px-6 pb-5 text-sm font-light leading-loose opacity-70 border-t border-brand-gold/5 pt-4 ml-9">
              {body}
            </p>
          </details>
        ))}
