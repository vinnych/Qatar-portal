    ...
    <>
      ...
      <header className="mb-16">
        ...
        <p className="text-base sm:text-lg font-light leading-relaxed opacity-70 max-w-xl">
          Plain-language terms for an honest platform. Read on — it is shorter
          than you expect.
        </p>
      </header>
      ...
      <ol className="space-y-0">
        {clauses.map(({ number, title, body }, i) => (
          ...
          >
            {/* Timeline line */}
            {i < clauses.length - 1 && (
              <div className="absolute left-[18px] top-10 bottom-0 w-[1px] bg-gradient-to-b from-brand-gold/20 to-transparent" />
            )}
